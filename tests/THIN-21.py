...
tests/THIN-21.py
────────────────
Executes the test pipeline for THIN-21.
"""
...
if __name__ == "__main__":
    ...
    files_to_delete = [
        os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "public", "report", "THIN-21.md")),
        os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "public", "code-review", "THIN-21.md"))
    ]
